...
| **Expert** | 실무자 | **analyzed_content + ceo_instructions** 기반 태스크 수행. 시각 디자인 태스크는 `docs/design-system.md` 참조 | sonnet |
| **QA** | 품질 검증자 | Expert 결과물 0~100점 채점. ACTION_VISUAL은 `docs/design-system.md` 기준 적용 | sonnet |
